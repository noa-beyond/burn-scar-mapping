...
import rioxarray 
import subprocess
from AOISentinelDownloader import Downloader
...
class Processor:
    ...
    def process_burned_area(self, start_date, end_date, lat, lon, output_dir):
        ...
        self.downloader.check_clouds_in_aoi(bb,output_dir,pre_name)
        nbr_post = self.download_n_create_nbr(post_id, output_dir, post_name)
        self.downloader.check_clouds_in_aoi(bb,output_dir,post_name)
